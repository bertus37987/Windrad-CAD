...
pip install cadquery  →  python rotor_hub_lower_8rod.py
"""
...
print("Exporting...")
cq.exporters.export(disc, "output/rotor_hub_lower_8rod.stl")
cq.exporters.export(disc, "output/rotor_hub_lower_8rod.step")
...
print("Done → output/rotor_hub_lower_8rod.stl + .step")
